    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 text-light">
                <h1>Mind Wisdoms</h1>
                <p class="w-desk">Mind(चित्त, मन ) the human faculty to which are ascribed thought, feeling, etc; often
                    regarded as an immaterial part of a person. intelligence or the intellect, esp as opposed to
                    feelings or wishes.
                </p>
            </div>
        </div>
