...
<html lang="en">
  ...
  <body>
    <h1>Meditation</h1>
    <div id="ing">
    <a href = "index.php"><img src="vector.png"></a>
    </div>
    <div id = "ig">
     <img src="yogdev.png">
    </div>
      ...
      <div class="vid-container">
        ...
        <div class="player-container">
            <audio class="song">
              ...
              <img src="play.svg" class="play"></img>
              ...
              <svg class="moving-outline" width="453" height="453" viewBox="0 0 453 453" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <img src="replay.svg" class="replay"></img>
            
                <h3 class="time-display">00:00</h3>      
      </div>
      <div class="sound-picker">
        <button data-sound="rain.mp3" data-video="./video/rain.mp4" ><img src="rain.svg" alt=""></button>
        <button data-sound="beach.mp3" data-video="./video/beach.mp4"><img src="beach.svg" alt=""></button>
      </div>
    </div>
