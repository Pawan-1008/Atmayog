        ...
        <div class="navbar-outer py-0">
            <nav class="navbar fixed-top navbar-expand-lg navbar-light">
                <div class="container py-0">
                    <a class="navbar-brand py-0 rounded-pill" href="./home.php"><img class="nav-image"
                            src="./assets/yog_lotus.png" alt="./home.php"><span class="text-theme">ATMAYOG</span>
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item mx-lg-2 my-0 py-0">
                                <a class="nav-link" href="./courses-in.php">Courses</a>
                            </li>
                            <li class="nav-item mx-lg-2 my-0 py-0">
                                <a class="nav-link" href="./wisdoms.php">Wisdoms</a>
                            </li>
                            <li class="nav-item mx-lg-2 my-0 py-0">
                                <a class="nav-link" href="./about-us-i.php">About us</a>
                            </li>
                        </ul>
                        <div class="d-flex">
